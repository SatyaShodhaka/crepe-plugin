package com.dsc.plugins.crepe.graphquery;
...
public class Const {
    ...
    public enum SpeechRecognitionType {
        ANDROID, GOOGLE_CLOUD
    };

    // public static final SpeechRecognitionType SELECTED_SPEECH_RECOGNITION_TYPE =
    // SpeechRecognitionType.ANDROID;
    public static final SpeechRecognitionType SELECTED_SPEECH_RECOGNITION_TYPE = SpeechRecognitionType.GOOGLE_CLOUD;

    // OVERLAY_TYPE should be either TYPE_APPLICATION_OVERLAY (sdk level >= 26) or
    // TYPE_PHONE for maximized compatibility
    public static final int OVERLAY_TYPE = (Build.VERSION.SDK_INT >= 26)
    ...
    // delay before running a script after clicking on OK in the
    // VariableSetValueDialog
    ...
    // switch between using SQL Dao and File Dao (SQL Dao has a max script size
    // issue)
    ...
    public static final String[] HOME_SCREEN_PACKAGE_NAMES = { "com.google.android.googlequicksearchbox",
            "com.google.android.apps.nexuslauncher" };

    // package names to excluded for recording & tracking
    public static final String[] ACCESSIBILITY_SERVICE_EXCEPTED_PACKAGE_NAMES = { "edu.cmu.hcii.sugilite",
            "com.android.systemui", "edu.cmu.hcii.sugilitecommunicationtest", "edu.cmu.helpr" };
    public static final String[] ACCESSIBILITY_SERVICE_TRACKING_EXCLUDED_PACKAGE_NAMES = {
            "edu.cmu.hcii.sugilitecommunicationtest", "edu.cmu.hcii.sugilite", "edu.cmu.helpr" };
    public static final String[] INPUT_METHOD_PACKAGE_NAMES = { "com.google.android.inputmethod.pinyin",
    ...
    public static final String[] INIT_INSTRUCTION_CONTEXT_WORDS = { "if", "when", "whenever", "order", "cold", "check",
            "bus", "schedule", "hotel", "room", "at least", "greater", "less", "below", "above", "cheaper", "colder",
            "cooler", "price", "temperature", "order" };
    ...
    public static final String[] COMPARISON_CONTEXT_WORDS = { "at least", "greater", "less", "below", "above",
            "cheaper", "colder", "cooler", "price", "temperature" };

    public static final String[] UI_UPLOAD_PACKAGE_BLACKLIST = { "com.google.android.inputmethod.pinyin",
            "com.google.android.inputmethod.latin", "com.menny.android.anysoftkeyboard" };
