...
public class SugiliteSerializableTriple implements Serializable {
    ...
    public SugiliteSerializableTriple(String subjectId, String objectId, String objectStringValue,
            String predicateStringValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SugiliteSerializableTriple) {
            ...
            if (((SugiliteSerializableTriple) obj).subjectId != null && this.subjectId != null
                    && (!((SugiliteSerializableTriple) obj).subjectId.equals(this.subjectId))) {
                return false;
            }
            ...
            if (((SugiliteSerializableTriple) obj).objectStringValue != null && this.objectStringValue != null
                    && (!((SugiliteSerializableTriple) obj).objectStringValue.equals(this.objectStringValue))) {
                return false;
            }
            ...
            if (((SugiliteSerializableTriple) obj).predicateStringValue != null && this.predicateStringValue != null
                    && (!((SugiliteSerializableTriple) obj).predicateStringValue.equals(this.predicateStringValue))) {
                return false;
            }
