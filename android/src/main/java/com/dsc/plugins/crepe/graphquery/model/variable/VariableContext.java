...
public class VariableContext implements Serializable {
    ...
    //
    // public static VariableContext
    // fromOperationBlockAndAlternativeNode(SugiliteOperationBlock
    // sugiliteOperationBlock, Node alternativeNode) {
    // VariableContext variableContext = new VariableContext();
    // if (sugiliteOperationBlock != null) {
    // if (sugiliteOperationBlock.getSugiliteBlockMetaInfo() != null &&
    // sugiliteOperationBlock.getSugiliteBlockMetaInfo().getUiSnapshot() != null) {
    ...
    // public static VariableContext
    // fromOperationBlockAndItsTargetNode(SugiliteOperationBlock
    // sugiliteOperationBlock) {
    // VariableContext variableContext = new VariableContext();
    // if (sugiliteOperationBlock != null) {
    // if (sugiliteOperationBlock.getSugiliteBlockMetaInfo() != null) {
    // if (sugiliteOperationBlock.getSugiliteBlockMetaInfo().getUiSnapshot() !=
    // null) {
    // variableContext.setActivityName(sugiliteOperationBlock.getSugiliteBlockMetaInfo().getUiSnapshot().getActivityName());
    // variableContext.setPackageName(sugiliteOperationBlock.getSugiliteBlockMetaInfo().getUiSnapshot().getPackageName());
    // }
    // if (sugiliteOperationBlock.getSugiliteBlockMetaInfo().getTargetEntity() !=
    // null) {
