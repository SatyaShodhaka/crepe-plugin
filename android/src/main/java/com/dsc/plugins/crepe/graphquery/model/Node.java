...
package com.dsc.plugins.crepe.graphquery.model;
...
public class Node implements Serializable {
    ...
    // private List<TextDistancePair> childrenTextLabels, nearbyTextLabels,
    // holisticTextLabels;
    ...
    public Node(AccessibilityNodeInfo nodeInfo, Integer windowZIndex, List<Integer> parentNodeZIndexSequence,
        ...
        // NOTE: AccessibilityNodeInfo.getDrawingOrder requires API Level 24 (Android
        // 7.0)
    ...
    public Node(AccessibilityNodeInfo nodeInfo, String activityName) {
        ...
        // if(rootNode != null) {
        // this.nearbyTextLabels = textLabelManager.getNearbyTextLabels(this, rootNode,
        // Const.NEARBY_TEXT_LABEL_LIMIT);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Node) {
            try {
                if (((this.packageName == null && ((Node) obj).packageName == null)
                        || this.packageName.equals(((Node) obj).packageName)) &&
                        ((this.className == null && ((Node) obj).className == null)
                                || this.className.equals(((Node) obj).className))
                        &&
                        ((this.boundsInScreen == null && ((Node) obj).boundsInScreen == null)
                                || this.boundsInScreen.equals(((Node) obj).boundsInScreen))
                        &&
                        ((this.viewId == null && ((Node) obj).viewId == null)
                                || this.viewId.equals(((Node) obj).viewId)))
                    return true;
